...
var tick = (elapsedTime, multiplier) => {
    ...
    currency1.value += dt * dt * getA1(a1.level);
}
...
var getA2 = (level) => Utils.getStepwisePowerSum(level, 120, 2, 1) * BigNumber.from(getA3(a3.level));
var getA3 = (level) => Utils.getStepwisePowerSum(level, 1e16, 2, 1) * BigNumber.from(getA4(a4.level));
var getA4 = (level) => Utils.getStepwisePowerSum(level, 1e30, 2, 1);
